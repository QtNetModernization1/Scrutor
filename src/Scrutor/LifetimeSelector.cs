...
#else
    var values = Enum.GetValues<Microsoft.Extensions.DependencyInjection.ServiceLifetime>();
#endif
    if (!values.Cast<Microsoft.Extensions.DependencyInjection.ServiceLifetime>().Contains(lifetime))
    {
