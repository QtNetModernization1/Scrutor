...
{
    if (!Enum.GetValues(typeof(Microsoft.Extensions.DependencyInjection.ServiceLifetime)).Cast<Microsoft.Extensions.DependencyInjection.ServiceLifetime>().Contains(lifetime))
    {
