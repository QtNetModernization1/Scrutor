...
/// Replaces existing service registrations using <see cref="ReplacementBehavior.Default"/>.
        ...
        /// <summary>
        /// Applies the <see cref="ServiceDescriptor"/> to the <see cref="IServiceCollection"/> of <see cref="ServiceDescriptor"/>.
        /// </summary>
    ...
    internal sealed class SkipRegistrationStrategy : RegistrationStrategy
    {
        ...
        {
            if (!System.Linq.Enumerable.Any<Microsoft.Extensions.DependencyInjection.ServiceDescriptor>(
                services,
