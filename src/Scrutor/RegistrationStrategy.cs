...
using ICollectionOfServiceDescriptor = System.Collections.Generic.ICollection<Microsoft.Extensions.DependencyInjection.ServiceDescriptor>;
...
/// Replaces existing service registrations using <see cref="ReplacementBehavior.Default"/>.
    ...
    public abstract void Apply(ICollectionOfServiceDescriptor services, ServiceDescriptor descriptor);

    private sealed class SkipRegistrationStrategy : RegistrationStrategy
    {
        public override void Apply(ICollectionOfServiceDescriptor services, ServiceDescriptor descriptor)
        {
