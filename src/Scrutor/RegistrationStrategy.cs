...
/// Replaces existing service registrations using <see cref="ReplacementBehavior.Default"/>.
    ...
    {
        public override void Apply(System.Collections.Generic.IEnumerable<ServiceDescriptor> services, ServiceDescriptor descriptor) => ((IServiceCollection)services).TryAdd(descriptor);
    }
