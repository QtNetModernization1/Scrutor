...
public class ServiceDescriptorAttribute : Attribute
{
    ...
    public ServiceDescriptorAttribute(Type? serviceType) : this(serviceType, (ServiceLifetime)System.Enum.Parse(typeof(ServiceLifetime), nameof(ServiceLifetime.Transient))) { }
