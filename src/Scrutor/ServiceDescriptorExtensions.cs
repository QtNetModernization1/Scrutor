...
{
    public static ServiceDescriptor WithImplementationFactory(this ServiceDescriptor descriptor, Func<IServiceProvider, System.Object> implementationFactory) =>
    ...
    public static ServiceDescriptor WithServiceType(this ServiceDescriptor descriptor, Type serviceType) => descriptor switch
    {
        ...
        { ImplementationFactory: Func<IServiceProvider, System.Object> factory } when factory != null =>
            new ServiceDescriptor(serviceType, sp => factory(sp), descriptor.Lifetime),
        { ImplementationInstance: System.Object instance } when instance != null =>
